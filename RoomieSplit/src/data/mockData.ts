...
export const MOCK_EXPENSES: Expense[] = [
  { id: '1', group_id: '1', description: 'Rent - April',  amount: 1500, payer_id: RAND_ID, created_by: RAND_ID, date: '2026-04-01', is_paid: false, created_at: '2026-04-01',
    profiles: { name: 'Rand' },
    expense_splits: [
  ...
  { id: '2', group_id: '1', description: 'Electric bill', amount: 90,  payer_id: REEM_ID, created_by: REEM_ID, date: '2026-03-28', is_paid: true, created_at: '2026-03-28',
    profiles: { name: 'Reem' },
    expense_splits: [
  ...
  { id: '3', group_id: '1', description: 'Groceries run', amount: 55,  payer_id: LAMA_ID, created_by: LAMA_ID, date: '2026-03-25', is_paid: false, created_at: '2026-03-25',
    profiles: { name: 'Lama' },
    expense_splits: [
  ...
  { id: '4', group_id: '1', description: 'Internet',      amount: 60,  payer_id: RAND_ID, created_by: RAND_ID, date: '2026-03-20', is_paid: false, created_at: '2026-03-20',
    profiles: { name: 'Rand' },
    expense_splits: [
...
export const MOCK_CHORES: Chore[] = [
  { id: '1', group_id: '1', icon: '', name: 'Vacuum living room', frequency: 'Weekly',    assigned_to: RAND_ID, created_by: RAND_ID, is_completed: true,  created_at: '2026-01-20', profiles: { name: 'Rand' } },
  { id: '2', group_id: '1', icon: '', name: 'Do laundry',         frequency: 'Weekly',    assigned_to: REEM_ID, created_by: RAND_ID, is_completed: false, created_at: '2026-01-20', profiles: { name: 'Reem' } },
  { id: '3', group_id: '1', icon: '', name: 'Wash dishes',        frequency: 'Daily',     assigned_to: LAMA_ID, created_by: RAND_ID, is_completed: false, created_at: '2026-01-20', profiles: { name: 'Lama' } },
  { id: '4', group_id: '1', icon: '', name: 'Groceries run',      frequency: 'Bi-weekly', assigned_to: RAND_ID, created_by: RAND_ID, is_completed: false, created_at: '2026-01-20', profiles: { name: 'Rand' } },
  { id: '5', group_id: '1', icon: '', name: 'Feed the cat',       frequency: 'Daily',     assigned_to: REEM_ID, created_by: RAND_ID, is_completed: false, created_at: '2026-01-20', profiles: { name: 'Reem' } },
];

export const MOCK_SETTLEMENTS: Settlement[] = [
  { id: '1', group_id: '1', from_user_id: REEM_ID, to_user_id: RAND_ID, amount: 120, paid: 0, created_by: RAND_ID, created_at: '2026-03-30',
    from_profile: { name: 'Reem' }, to_profile: { name: 'Rand' } },
  { id: '2', group_id: '1', from_user_id: LAMA_ID, to_user_id: RAND_ID, amount: 115, paid: 0, created_by: RAND_ID, created_at: '2026-03-30',
