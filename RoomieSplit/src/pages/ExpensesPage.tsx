            ...
            <tbody>
              ...
              paginatedExpenses.map(expense => (
                <ExpenseRow
                  ...
                  status={getExpenseStatus(expense, settlementsByExpenseId)}
                  canManageExpense={canManageExpense(expense)}
                  archiveAllowed={canArchiveExpense(expense, settlementsByExpenseId)}
                  onEdit={() => openEdit(expense)}
                  onArchive={() => setConfirmArchiveId(expense.id)}
                  onUnarchive={() => setConfirmUnarchiveId(expense.id)}
